...
public abstract class FakerParamStatementImpl extends ASTWrapperPsiElement implements FakerParamStatement {

  public FakerParamStatementImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull FakerVisitor visitor) {
    visitor.visitParamStatement(this);
  }
