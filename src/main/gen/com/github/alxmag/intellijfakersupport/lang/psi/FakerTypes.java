...
public interface FakerTypes {
  ...
  IElementType L_1_PARAM_LIST = new FakerElementType("L_1_PARAM_LIST");
  ...
  IElementType L_2_PARAM_LIST = new FakerElementType("L_2_PARAM_LIST");
  ...
  class Factory {
    public static PsiElement createElement(ASTNode node) {
      ...
      else if (type == L_1_PARAM_LIST) {
        return new FakerL1ParamListImpl(node);
      }
      ...
      else if (type == L_2_PARAM_LIST) {
        return new FakerL2ParamListImpl(node);
      }
